...
public class RefreshLoadMoreGridActivity extends Activity implements RefreshLoadMoreRecycleView.IOnScrollListener{
    ...
    public void initView(){
        dialog = new ProgressDialog(RefreshLoadMoreGridActivity.this);
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(RefreshLoadMoreGridActivity.this,2);
        recycleView.setLayoutManager(gridLayoutManager);
        adapter = new RefreshLoadMoreRecycleAdapter(RefreshLoadMoreGridActivity.this,list);
    ...
    public void onLoaded() {
        Toast.makeText(RefreshLoadMoreGridActivity.this,getString(R.string.loaded_all),Toast.LENGTH_SHORT).show();
    }
